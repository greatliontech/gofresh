...
| [shortgates-pin-shared-home](shortgates-pin-shared-home.md) | pew still carries a copy of the fast-tier gate checker gofresh exports as `shortgates.Pin` (gomutant and stipulator collapsed) | pew's bump, chunk 157 |
