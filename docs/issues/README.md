...
| [unlisted-toolchain-refusals-lack-naming-diagnostic](unlisted-toolchain-refusals-lack-naming-diagnostic.md) | consumers on an unlisted toolchain see generic refusals, not the release that needs walking | folds into train chunk 108 (canary suites) |
